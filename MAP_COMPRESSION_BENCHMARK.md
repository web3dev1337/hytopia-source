...
## Results: `sdk-examples/big-world/assets/map.json`
...
- read: `19.52ms`
- parse: `399.01ms`
- `loadMap(WorldMap)`: median `2.96s` (min `2.88s`, max `3.10s`, runs `3`)
...
- `loadMap(CompressedWorldMap)`: median `2.37s` (min `2.26s`, max `2.51s`, runs `3`)
...
## Results: `assets/release/maps/boilerplate.json`
...
- read: `23.73ms`
- parse: `621.83ms`
- `loadMap(WorldMap)`: median `5.27s` (min `5.19s`, max `5.82s`, runs `3`)

### Native compressed map (`CompressedWorldMap`)

Generated by the benchmark with `brotli` level `9`:
- compressed JSON size: `439.94KB` (`98.48%` smaller vs source file)
- `loadMap(CompressedWorldMap)`: median `4.46s` (min `4.23s`, max `4.58s`, runs `3`)
